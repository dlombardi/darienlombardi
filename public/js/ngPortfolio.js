...
dl.controller("dController", ['$scope', '$http', function($scope, $http){
  ...
  $scope.portfolio = [
    ...
    { title:"Google Places Search", image: "/public/images/google_places_search.png", website: "placessearch.gq", github: "https://github.com/dlombardi/Google-Places-SearchTool" ,techs:["Angular","Gulp","Google materialize","Google maps places library"]},
